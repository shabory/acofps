                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.zooms.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('zoomlink') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="zoomlink" id="zoomlink" value="{{ old('zoomlink', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('zoomtime') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="zoomtime" id="zoomtime" value="{{ old('zoomtime') }}" required>
