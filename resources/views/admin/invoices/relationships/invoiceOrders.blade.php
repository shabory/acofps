            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-invoiceOrders">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.order.fields.diploma') }}
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                @foreach($orders as $key => $order)
                                    <tr data-entry-id="{{ $order->id }}">
                                        ...
                                        <td>
                                            {{ $order->invoice->payment_refrence ?? '' }}
                                        </td>
                                        <td>
                                            {{ $order->invoice->payment_refrence ?? '' }}
                                        </td>
...
@endcan
  ...
  let table = $('.datatable-invoiceOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
