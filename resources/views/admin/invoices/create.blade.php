                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.invoices.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('payment_time') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="payment_time" id="payment_time" value="{{ old('payment_time') }}">
                        ...
                        <div class="form-group {{ $errors->has('payment_refrence') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="payment_refrence" id="payment_refrence" value="{{ old('payment_refrence', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('qeoud_registerd') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Invoice::QEOUD_REGISTERD_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="qeoud_registerd_{{ $key }}" name="qeoud_registerd" value="{{ $key }}" {{ old('qeoud_registerd', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('qeoud_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="qeoud_number" id="qeoud_number" value="{{ old('qeoud_number', '') }}">
